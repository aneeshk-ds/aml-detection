...
3. Done 2026-09-14: thresholds set on 2022-09-01 to 09-05 and reported on 09-06 to 09-10. Lift rose from 8.06 to 11.50 and the velocity threshold landed on 20 in both windows, but the cutoff rule picked 6 on train against 4 on test. See [holdout.md](holdout.md).
